...
/obj/item/weapon/gun/tl102
	...
	desc = "The HSG-102 heavy machinegun, it's too heavy to be wielded or operated without the tripod. IFF capable. No extra work required, just deploy it with Right Click. Can be repaired with a blowtorch once deployed."
