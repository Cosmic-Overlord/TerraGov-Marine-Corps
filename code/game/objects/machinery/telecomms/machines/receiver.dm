...
/obj/machinery/telecomms/receiver/preset_left/rebel
	...
	freq_listening = list(FREQ_MEDICAL_REBEL, FREQ_REQUISITIONS_REBEL, FREQ_ALPHA_REBEL, FREQ_BRAVO_REBEL, FREQ_CHARLIE_REBEL, FREQ_DELTA_REBEL, FREQ_FOREIGN_REBEL, FREQ_COMMAND_REBEL, FREQ_ENGINEERING_REBEL, FREQ_CAS_REBEL, FREQ_PMC, FREQ_COLONIST, FREQ_USL, FREQ_DEATHSQUAD, FREQ_IMPERIAL, FREQ_SOM, FREQ_SECTOID, FREQ_ECHO)
