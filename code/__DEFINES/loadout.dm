...
GLOBAL_LIST_INIT(medic_gear_listed_products, list(
		...
		/obj/item/storage/box/t312case = list(CAT_MEDSUP, "R-312 'Albedo' Revolver", 8, "black"),
		/obj/effect/vendor_bundle/neu_bullets = list(CAT_MEDSUP, "R-312 Neuraline bullets kit", 2, "black"),
	))
...
GLOBAL_LIST_INIT(smartgunner_gear_listed_products, list(
	...
	/obj/item/storage/belt/gun/pistol/smart_pistol/full = list(CAT_ESS, "SP-13 smart pistol", 0, "white"),
...
GLOBAL_LIST_INIT(synthetic_clothes_listed_products, list(
		...
		/obj/item/clothing/shoes/white = list(CAT_SHO, "White shoes", 0, "synth-cosmetic"),
		/obj/item/clothing/shoes/brown = list(CAT_SHO, "Brown shoes", 0, "synth-cosmetic"),
		/obj/item/clothing/shoes/leather = list(CAT_SHO, "Leather Shoes", 0, "synth-cosmetic"),
		/obj/item/clothing/shoes/centcom = list(CAT_SHO, "Dress Shoes", 0, "synth-cosmetic"),
		/obj/item/clothing/shoes/black = list(CAT_SHO, "Black Shoes", 0, "synth-cosmetic"),
		/obj/item/storage/pouch/general/large = list(CAT_POU, "General pouch", 0, "black"),
