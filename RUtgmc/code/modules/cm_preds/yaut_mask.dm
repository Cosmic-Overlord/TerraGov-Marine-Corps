...
/obj/item/clothing/mask/gas/yautja
	...
	time_to_unequip = 20
	anti_hug = 5
	var/list/mask_huds = list(DATA_HUD_MEDICAL_OBSERVER, DATA_HUD_XENO_STATUS, DATA_HUD_SECURITY_ADVANCED, DATA_HUD_SQUAD_TERRAGOV, DATA_HUD_SQUAD_REBEL, DATA_HUD_SQUAD_SOM, DATA_HUD_ORDER)
