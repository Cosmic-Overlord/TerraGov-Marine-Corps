...
/mob/living/carbon/human/proc/pred_buy()
	...
	switch(main_weapon)
		if(YAUTJA_GEAR_GLAIVE)
			equip_to_slot_if_possible(new /obj/item/weapon/twohanded/yautja/glaive(src.loc), SLOT_IN_STORAGE, warning = TRUE)
		if(YAUTJA_GEAR_GLAIVE_ALT)
			equip_to_slot_if_possible(new /obj/item/weapon/twohanded/yautja/glaive/alt(src.loc), SLOT_IN_STORAGE, warning = TRUE)
		if(YAUTJA_GEAR_WHIP)
			equip_to_slot_if_possible(new /obj/item/weapon/yautja/chain(src.loc), SLOT_IN_STORAGE, warning = TRUE)
		if(YAUTJA_GEAR_SWORD)
			equip_to_slot_if_possible(new /obj/item/weapon/yautja/sword(src.loc), SLOT_IN_STORAGE, warning = TRUE)
		if(YAUTJA_GEAR_SCYTHE)
			equip_to_slot_if_possible(new /obj/item/weapon/yautja/scythe(src.loc), SLOT_IN_STORAGE, warning = TRUE)
		if(YAUTJA_GEAR_SCYTHE_ALT)
			equip_to_slot_if_possible(new /obj/item/weapon/yautja/scythe/alt(src.loc), SLOT_IN_STORAGE, warning = TRUE)
		if(YAUTJA_GEAR_STICK)
			equip_to_slot_if_possible(new /obj/item/weapon/yautja/combistick(src.loc), SLOT_IN_STORAGE, warning = TRUE)
	...
	for(var/choice in secondaries)
		switch(choice)
			...
			if(YAUTJA_GEAR_DRONE)
				equip_to_slot_if_possible(new /obj/item/falcon_drone(src.loc), SLOT_EARS, warning = TRUE)
